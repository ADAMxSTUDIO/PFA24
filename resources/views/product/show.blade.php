...
<body>
    ...
    <form action="{{ route('order.store', ['product_id' => $product->id]) }}" method="POST" class="ml-3">
        @csrf
        <div class="fashion_section mt-5">
            <div class="container-fluid">
                ...
                @endif
                    ...
                    <h1 class="fashion_taital" style="margin-bottom: 100px;">{{ $product->category->label }}</h1>
                    <div class="fashion_section_2 d-flex" style="gap: 70px;">
                        <div class="row">
                            <div class="col-lg-4 col-sm-4" style="min-width: 600px; min-hight: 100%;">
                                <div class="box_main">
                                    <h4 class="shirt_text">{{ $product->label }}</h4>
                                    <p class="price_text">Price <span style="color: #262626;">$
                                            {{ $product->price }}</span></p>
                                    <div class="tshirt_img"><img src="{{ asset('storage/' . $product->poster) }}">
                                    </div>
                                    <div class="btn_main">
                        ...
                        <div>
                            ...
                            <div class="quantity">
                                ...
                                <small class="ml-3">{{ $product->quantity }} article(s) are left</small>
                            </div>
                        </div>
                    </div>
            </div>
