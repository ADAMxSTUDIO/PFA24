...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastNameFemale = [
        ...
        'Žukauskienė', 'Urbonienė', 'Kavaliauskienė', 'Navickienė', 'Kazlauskaitė', 'Jankausn      - Composite.Dev.NT
     dvi:      Rank         - 0x00ff2006
     dvi:      Signer Score - INBOX
     dvi:      DrvDate      - 06/21/2006
     dvi:      Version      - 10.0.22621.3672
<<<  Section end 2024/07/20 09:43:38.615
<<<  [Exit status: SUCCESS]


>>>  [Build Driver List - ROOT\UNNAMED_DEVICE\0000]
>>>  Section start 2024/07/20 09:43:28.319
      cmd: "C:\Program Files (x86)\Intel\Driver and Support Assistant\DSAService.exe"
     dvi: Searching for hardware ID(s):
     dvi:      usb\vid_0955&pid_9000
     dvi: Created Driver Node:
     dvi:      HardwareID   - USB\VID_0955&PID_9000
     dvi:      InfName      - C:\WINDOWS\System32\DriverStore\FileRepository\nvvad.inf_amd64_35079c3b2e98dd66\nvvad.inf
     dvi:      DevDesc      - NVIDIA Virtual Audio Device (Wave Extensible) (WDM)
     dvi:      Section      - NVVAD_WaveExtensible64.NT
     dvi:      Rank         - 0x00ff0000
     dvi:      Signer Score - WHQL
     dvi:      DrvDate      - 02/28/2024
     dvi:      Version      - 4.65.0.3
     dvi: Created Driver Node:
     dvi:      HardwareID   - USB\VID_0955&PID_9000
     dvi:      InfName      - C:\WINDOWS\System32\DriverStore\FileRepository\nvvad.inf_amd64_912693bf1dfeff0b\nvvad.inf
     dvi:      DevDesc      - NVIDIA Virtual Audio Device (Wave Extensible) (WDM)
     dvi:      Section      - NVVAD_WaveExtensible64.NT
     dvi:      Rank         - 0x00ff0000
     dvi:      Signer Score - WHQL
     dvi:      DrvDate      - 09/13/2021
     dvi:      Version      - 4.39.0.0
     dvi: Created Driver Node:
     dvi:      HardwareID   - USB\VID_0955&PID_9000
     dvi:      InfName      - C:\WINDOWS\System32\DriverStore\FileRepository\nvvad.inf_amd64_6c2ba0d2ff6d3b11\nvvad.inf
     dvi:      DevDesc      - NVIDIA Virtual Audio Device (Wave Extensible) (WDM)
     dvi:      Section      - NVVAD_WaveExtensible64.NT
     dvi:      Rank         - 0x00ff0000
     dvi:      Signer Score - WHQL
     dvi:      DrvDate      - 07/12/2022
     dvi:      Version      - 4.45.0.0
     dvi: Created Driver Node:
     dvi:      HardwareID   - USB\VID_0955&PID_9000
     dvi:      InfName      - C:\WINDOWS\System32\DriverStore\FileRepository\nvvad.inf_amd64_3328072030df5d56\nvvad.inf
     dvi:      DevDesc      - NVIDIA Virtual Audio Device (Wave Extensible) (WDM)
     dvi:      Section      - NVVAD_WaveExtensible64.NT
     dvi:      Rank         - 0x00ff0000
     dvi:      Signer Score - WHQL
     dvi:      DrvDate      - 09/22/2022
     dvi:      Version      - 4.49.0.0
<<<  Section end 2024/07/20 09:43:33.117
<<<  [Exit status: SUCCESS]


>>>  [Build Driver List - PCI\VEN_8086&DEV_9B54&SUBSYS_14451025&REV_02\3&11583659&0&00]
>>>  Section start 2024/07/20 09:43:28.385
      cmd: "C:\Program Files (x86)\Intel\Driver and Support Assistant\DSAService.exe"
     dvi: Searching for hardware ID(s):
     dvi:      pci\ven_8086&dev_9b54&subsys_14451025&rev_02
     dvi:      pci\ven_8086&dev_9b54&subsys_14451025
     dvi:      pci\ven_8086&dev_9b54&cc_060000
     dvi:      pci\ven_8086&dev_9b54&cc_0600
     dvi: Searching for compatible ID(s):
     dvi:      pci\ven_8086&dev_9b54&rev_02
     dvi:      pci\ven_8086&dev_9b54
     dvi:      pci\ven_8086&cc_060000
     dvi:      pci\ven_8086&cc_0600
     dvi:      pci\ven_8086
     dvi:      pci\cc_060000
     dvi:      pci\cc_0600
     dvi: Created Driver Node:
     dvi:      HardwareID   - PCI\CC_0600
     dvi:      InfName      - C:\WINDOWS\System32\DriverStore\FileRepository\machine.inf_amd64_7a70b48d91e57025\machine.inf
     dvi:      DevDesc      - PCI standard host CPU bridge
     dvi:      Section      - NO_DRV
     dvi: 