...
<body>
    <section class="container-fluid p-5 w-25 bg-warning">
        ...
        <h1 class="p-5 text-center">LOG IN</h1><br>
...
unset($__errorArgs, $__bag); ?>
            ...
            <input name="submit" type="submit" class="btn btn-light w-100 mt-4" value="Login" />
        </form>
    </section>
...
<?php /**PATH C:\Users\ADAM\OneDrive\Documents\EMSI\3rd Grade\Phase 2\Projects\PFA\Realisation\app\resources\views/auth/login.blade.php ENDPATH**/ ?>